...
<table style="font-size:12px; color: #666; border: 1px solid #ccc;">
    ...
    <tr>
        ...
        <td>
            <a href="<?php echo base_url();?>super_admin/edit_services/<?php echo $values->content_id;?>">Edit &nbsp;</a>
            <a href="<?php echo base_url();?>super_admin/delete_services/<?php echo $values->content_id;?>" onclick=" return checkDelete();">Delete</a>
        </td>
